(()=>{
  ...
  function apply(){
    ...
    if(help)help.textContent="Adjust the vehicle price, down payment, trade-in, rate, term or payment frequency to explore your estimate.";
    ...
    if(boundPanel!==panel){
      ...
      ["poVehiclePrice","poDown","poTrade","poRate","poTerm","poFreq","poTax"].forEach(fieldId=>$(fieldId)?.addEventListener("input",()=>setTimeout(calculate)));
